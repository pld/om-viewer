...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_9400 = 0;while(true){
if((i_9400 < arr.length))
{(arr[i_9400] = null);
{
var G__9401 = (i_9400 + 1);
i_9400 = G__9401;
continue;
}
} else
...
{var i_9407 = (self__.level + 1);while(true){
if((i_9407 <= (new_level + 1)))
{(update[i_9407] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_9409 = 0;while(true){
if((i_9409 <= self__.level))
{var links_9410 = (update[i_9409]).forward;if(((links_9410[i_9409]) === x__$1))
{(links_9410[i_9409] = (x__$1.forward[i_9409]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3401__auto__ = (cljs.core.truth_((function (){var and__3389__auto__ = me;if(cljs.core.truth_(and__3389__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3389__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3401__auto__))
