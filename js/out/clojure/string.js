...
{{
var G__13253 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13253;
continue;
}
} else
...
{var pred__13257 = cljs.core._EQ_;var expr__13258 = limit;if(cljs.core.truth_(pred__13257.call(null,1,expr__13258)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13257.call(null,2,expr__13258)))
...
{var ch = s.charAt(index);var temp__4090__auto___13264 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13264))
{var replacement_13265 = temp__4090__auto___13264;buffer.append([cljs.core.str(replacement_13265)].join(''));
} else
{buffer.append(ch);
}
{
var G__13266 = (index + 1);
index = G__13266;
continue;
}
}
