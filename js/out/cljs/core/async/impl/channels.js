...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11789 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11789 = (function (val,box,meta11790){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11789.cljs$lang$type = true;
cljs.core.async.impl.channels.t11789.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11789";
cljs.core.async.impl.channels.t11789.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t11789");
});
cljs.core.async.impl.channels.t11789.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11789.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11791){var self__ = this;
var _11791__$1 = this;return self__.meta11790;
});
cljs.core.async.impl.channels.t11789.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11791,meta11790__$1){var self__ = this;
var _11791__$1 = this;return (new cljs.core.async.impl.channels.t11789(self__.val,self__.box,meta11790__$1));
});
cljs.core.async.impl.channels.__GT_t11789 = (function __GT_t11789(val__$1,box__$1,meta11790){return (new cljs.core.async.impl.channels.t11789(val__$1,box__$1,meta11790));
});
}
return (new cljs.core.async.impl.channels.t11789(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_11792 = self__.takes.pop();if((taker_11792 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11792))
{var take_cb_11793 = cljs.core.async.impl.protocols.commit.call(null,taker_11792);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11793,taker_11792){
return (function (){return take_cb_11793.call(null,null);
});})(take_cb_11793,taker_11792))
);
} else
{}
{
