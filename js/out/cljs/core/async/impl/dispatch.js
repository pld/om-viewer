...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_9435 = 0;while(true){
var m_9436 = cljs.core.async.impl.dispatch.tasks.pop();if((m_9436 == null))
{} else
{m_9436.call(null);
if((count_9435 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__9437 = (count_9435 + 1);
count_9435 = G__9437;
continue;
}
} else
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3389__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3389__auto__)
